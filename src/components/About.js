...
export default function About(props) {
    return (
        <>
            ...
            <div class="about-section my-4" style={{ color: props.mode === 'light' ? 'black' : 'white' }} >
                <h1>About Textwise</h1>
                <p class="aboutTextWise my-3 mx-4" style={{ color: props.mode === 'light' ? 'black' : 'white' }}>
                    TextWise is a web application built using React that provides various text manipulation and analysis features.
                    Key Features:
                    <ol >
                        <li class="my-3">Text conversion: Enables users to convert text to lowercase, uppercase, and other formats effortlessly.</li>
